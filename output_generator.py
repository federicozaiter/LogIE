...
from the templates. CONSIDERED

Then a method that given a string and a matched template, outputs the
variables found on the string. (simply the matcher from the mathing tree)
IT'S WHAT THE MATCHER ALREADY DOES

I could eventually have a method that takes triples, templates and logs
and outputs the triples in the format that Weibin wants."""
